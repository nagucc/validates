(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/core-js/object/keys'), require('babel-runtime/core-js/number/is-integer'), require('babel-runtime/core-js/number/is-nan')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/core-js/object/keys', 'babel-runtime/core-js/number/is-integer', 'babel-runtime/core-js/number/is-nan'], factory) :
  (factory((global.nagu-validates = global.nagu-validates || {}),global._Object$keys,global._Number$isInteger,global._Number$isNaN));
}(this, function (exports,_Object$keys,_Number$isInteger,_Number$isNaN) { 'use strict';
  ...
  _Number$isNaN = 'default' in _Number$isNaN ? _Number$isNaN['default'] : _Number$isNaN;
